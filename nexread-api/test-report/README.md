...
| Jest e2e loan scenario                | Cart checkout transaction, borrow/return, overdue filters, RBAC, and analytics    |
| `10 - Loans and Admin Analytics`      | Cart, pagination, recommendations, Reviews lifecycle, loans, users, and analytics |
...
- End-to-end tests: `npm run test:e2e` (source: `test/`; covers health, refresh-token security, `/me`, author/category deletion rules, cart checkout, loan lifecycle, filtering, RBAC, dashboard, and aggregation)
